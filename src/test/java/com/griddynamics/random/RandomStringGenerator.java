...
public class RandomStringGenerator {
    ...
    public RandomStringGenerator(final int minLength, final int maxLength) {
    ...
    public String generate(@NotNull final String regex) {
        Random random = new Random();
    ...
    private byte[] generateMatchingChar(@NotNull final Random random, @NotNull final Pattern pattern) {
        byte[] array;
        do {
            array = new byte[1];
            random.nextBytes(array);
